...
public final class prescriptionForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            \n");
      out.write("            <input type=\"text\" placeholder=\"Enter Client ID\" name=\"cid\" required>\n");
      ...
      out.write("            <input type=\"text\" placeholder=\"Date Prescribed (FORMAT YYYY/MM/DD)\" name=\"date\" pattern=\"(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))\" required>\n");
